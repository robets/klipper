...
static const struct gpio_pwm_info pwm_regs[] = {
    ...
    { GPIO('A', 6),  'E', 1, 0 },
    { GPIO('A', 7),  'E', 1, 1 },
    { GPIO('A', 8),  'E', 0, 0 }, // Alt: TCC1[2]?
    { GPIO('A', 9),  'E', 0, 1 }, // Alt: TCC1[3]
    { GPIO('A', 10), 'E', 1, 0 }, // Alt: TCC0[2]
    { GPIO('A', 11), 'E', 1, 1 }, // Alt: TCC0[4]
    { GPIO('A', 12), 'E', 0, 6 },
    { GPIO('A', 13), 'E', 0, 7 },
    { GPIO('A', 16), 'E', 2, 0 }, // Alt: TCC0[6]
    { GPIO('A', 17), 'E', 2, 1 }, // Alt: TCC0[7]
    { GPIO('A', 18), 'F', 0, 2 },
    { GPIO('A', 19), 'F', 0, 3 },
    { GPIO('A', 24), 'F', 1, 2 },
    { GPIO('A', 25), 'F', 1, 3 },
...
gpio_pwm_setup(uint8_t pin, uint32_t cycle_time, uint8_t val)
{
    ...
    // Set initial value
    struct gpio_pwm g = (struct gpio_pwm) { (void*)&tcc->CCBUF[p->channel].reg };
